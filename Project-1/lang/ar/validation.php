...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'booking_id'            =>'معرف الرحلة',
        'activity_id'           =>'معرف النشاط',
        'user_id'               =>'معرف المستخدم',
        'area_id'               =>'معرف المنطقة',
        'plane_id'              =>'معرف الطيارة',
        'money'                 =>'المال',
        'payments'              =>'المدفوعات',
        'source_trip_id'        =>'مصدر الرحلة',
        'destination_trip_id'   =>'وجهة الرحلة',
        'trip_name'             =>'اسم الرحلة',
        'number_of_people'      =>'عدد الأشخاص',
        'start_date'            =>'تاريخ البدأ',
        'trip_capacity'         =>'سعة الرحلة',
        ...
        'static_trip_id'        =>'معرف الرحلة المحجوزة',
        'number_of_friend'      =>'عدد الأصدقاء',
        'book_price'            =>'سعر الرحلة',
        'place_id'              =>'معرف المكان',
        'place_note'            =>'ملاحظة المكان',
        'plane_trip_id'         =>'معرف رحلة الطيران',
        'comment'               =>'تعليق',
        'code'                  =>'كود التأكيد الشخصي',
        'number_rooms'          =>'عدد الغرف',
        'hotel_id'              =>'معرف الفندق',
        'place_price'           =>'تكلفة الدخول للمكان',
        'text'                  =>'تعريف المكان',
        'category_id'           =>'معرف التصنيف',
        'visible'               =>'القدرة على الرؤية',
        'number_of_seats'       =>'عدد المقاعد',
        'status'                =>'الحالة',
        'ticket_price'          =>'تكلفة التذكرة',
        'airport_id'            =>'معرف المطار',
        'airport_source_id'     =>'معرف مطار المصدر',
        'airport_destination_id'=>'معرف مطار الوجهة',
        'country_source_id'     =>'معرف الدولة المصدر',
        'country_destination_id'=>'معرف الدولة الوجهة',
        'available_seats'       =>'عدد المقاعد المتاحة',
        'flight_date'           =>'تاريخ اللإقلاع',
        'landing_date'          =>'تاريخ الهبوط',
        'capacity'              =>'السعة',
        'booking_static_trip_id'=>'معرف الرحلة المحجوزة',
        'is_approved'           =>'القبول',
        'point'                 =>'النقاط',
